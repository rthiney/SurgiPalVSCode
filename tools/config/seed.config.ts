...
export class SeedConfig {
   ...
   * @type {string}
   */
  CSS_SRC = `${this.APP_SRC}/assets/styles`;
  ...
  APP_ASSETS: InjectableDependency[] = [
    ...
    { src: `${this.ASSETS_SRC}/extra/progressButton/classie.js`, inject: 'libs'},
    { src: `${this.ASSETS_SRC}/extra/progressButton/modernizr.custom.js`, inject: 'libs'},
    { src: `${this.ASSETS_SRC}/extra/progressButton/progressButton.js`, inject: 'libs'},
    { src: `${this.ASSETS_SRC}/extra/growl/css/growl.css`, inject: true },
    { src: `${this.ASSETS_SRC}/extra/growl/js/growl.js`, inject: 'libs' },
    { src: `${this.ASSETS_SRC}/extra/datetimepicker/css/bootstrap-datetimepicker.css`, inject: true },
    { src: `${this.ASSETS_SRC}/extra/datetimepicker/js/bootstrap-datetimepicker.min.js`, inject: 'libs' }
  ];
